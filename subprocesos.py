...
from concurrent.futures import ThreadPoolExecutor #1.-ThreadPoolExecutor = maneja un conjunto de hilos de trabajo, pasándoles 
                                                  #tareas a medida que estén disponibles para más trabajo.
#2.- concurrent.futures=proporcionan interfaces para ejecutar tareas utilizando grupos de subprocesos o trabajadores de proceso
import os
